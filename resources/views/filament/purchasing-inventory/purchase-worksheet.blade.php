                ...
                <tbody>
                    @foreach ($rows as $index => $row)
                        ...
                        <tr wire:key="pu-line-{{ $row['line_id'] }}">
                            ...
                            <td class="agricart-pp-worksheet__col-num"><input type="text" class="agricart-pp-worksheet__cell-input" wire:model.blur="rows.{{ $index }}.purchase_rate" wire:change="recalculateRowTiersFromSettings({{ $index }})" /></td>
