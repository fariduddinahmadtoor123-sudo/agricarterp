@php
    $presenter = app(\App\Support\ProductCatalog\ProductCatalogOverviewPresenter::class);
    $stats = $presenter->stats();
    $links = $presenter->quickLinks();
@endphp

<div class="agricart-pc-overview">
    <section class="agricart-pc-overview__section" aria-labelledby="pc-overview-stats-heading">
        <header class="agricart-pc-overview__section-header">
            <h2 id="pc-overview-stats-heading" class="agricart-pc-overview__section-title">Catalog Statistics</h2>
            <p class="agricart-pc-overview__section-subtitle">Live counts across products and master data.</p>
        </header>
    ...
    <section class="agricart-pc-overview__section" aria-labelledby="pc-overview-links-heading">
        <header class="agricart-pc-overview__section-header">
            <h2 id="pc-overview-links-heading" class="agricart-pc-overview__section-title">Quick Links</h2>
            <p class="agricart-pc-overview__section-subtitle">Jump directly to any Product Catalog workspace.</p>
        </header>
