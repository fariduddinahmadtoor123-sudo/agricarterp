...
class SupplierDocumentStorage
{
    ...
    {
        return (string) config('contacts.supplier_documents_disk', 'local');
    }
     ...
     */
    public function cleanupReplacedFiles(SupplierDocument $document, array $newPaths): void
    {
