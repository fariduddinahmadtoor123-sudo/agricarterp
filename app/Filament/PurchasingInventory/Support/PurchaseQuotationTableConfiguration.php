...
class PurchaseQuotationTableConfiguration
{
    /**
     * @return list<string>
     */
    ...
    public static function applyListLayout(Table $table): Table
    {
        return $table
            ->extraAttributes([
                'class' => 'agricart-contacts-list agricart-contacts-list-purchase-quotations',
            ])
            ...
            ->filtersFormSchema(fn (array $filters): array => [
                PurchasingInventoryListToolbar::primaryFiltersGroup($filters, static::primaryFilterKeys(), [
                    'status' => 'agricart-pq-filter-status-wrap',
                ]),
            ]);
    }
        ...
        return [
            SelectFilter::make('status')
                ...
                ->modifyFormFieldUsing(fn (Select $select): Select => $select
                    ...
                    ->placeholder('Status')
                    ->native(false)
                    ->extraAttributes(['class' => 'agricart-pq-filter-status'])),
        ];
    }
}
