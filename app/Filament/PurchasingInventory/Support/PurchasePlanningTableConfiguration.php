...
class PurchasePlanningTableConfiguration
{
    /**
     * @return list<string>
     */
    ...
    public static function applyListLayout(Table $table): Table
    {
        return $table
            ->extraAttributes([
                'class' => 'agricart-contacts-list agricart-contacts-list-purchase-planning',
            ])
            ...
            ->filtersFormSchema(fn (array $filters): array => [
                PurchasingInventoryListToolbar::primaryFiltersGroup($filters, static::primaryFilterKeys(), [
                    'status' => 'agricart-pp-filter-status-wrap',
                ]),
            ]);
    }
        ...
        return [
            SelectFilter::make('status')
                ...
                ->modifyFormFieldUsing(fn (Select $select): Select => $select
                    ...
                    ->placeholder('Status')
                    ->native(false)
                    ->extraAttributes(['class' => 'agricart-pp-filter-status'])),
        ];
    }
}
